...
rm -rf pub/static/frontend/Hidden/apparel/fr_FR
...
echo ">> Deploying static content for theme Hidden/apparel (fr_FR)..."
bin/magento setup:static-content:deploy fr_FR --theme Hidden/apparel -f
