# How to contribute Arabic Language pack
...
- We will merge `github_contributions.csv` with [ar_MA.csv](https://github.com/mageplaza/magento-2-arabic-language-pack/blob/master/ar_MA.csv). Your Magento 2 store will use this csv file.
...
#### Suggestions
- You can copy any part of `ar_MA.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `ar_MA.csv`, we will not approve it in this case.
