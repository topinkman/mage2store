...
php bin/magento setup:static-content:deploy ar_MA
...
Rename folder `magento-2-arabic-language-pack` to `ar_ma`.
...
Unzip the compressed file and upload file `master.zip` into `app/i18n/Mageplaza/ar_ma/`

See this screenshot:

![Arabic pack](https://cdn3.mageplaza.com/media/general/language-pack.png)

This language pack code is: **ar_ma**
